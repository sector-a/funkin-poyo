...
class PlayState extends MusicBeatState {
	...
	override public function create() {
		...
		if (FlxG.save.data.bgNotesAlpha != 0) {
			var notesBgBF:FlxSprite = new FlxSprite(FlxG.save.data.middleScroll ? (FlxG.width / 2) - (notesBgBF.width / 2) : (FlxG.width / 2) + 80, 0).makeGraphic(490, FlxG.height, FlxColor.BLACK);
